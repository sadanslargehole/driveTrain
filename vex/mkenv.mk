...
# CFLAGS    = ${CFLAGS_CL} ${CFLAGS_V7} -Os -Wall -Werror -Wpedantic -ansi -std=gnu99 $(DEFINES)
CFLAGS    = ${CFLAGS_CL} ${CFLAGS_V7} -Os -Wall -Werror -Wpedantic -ansi -std=gnu99 $(DEFINES)
# cxx_warn_ignores = -Wno-c++20-designator -Wno-keyword-macro -Wno-gnu-include-next
# CXX_FLAGS = ${CFLAGS_CL} ${CFLAGS_V7} -Os -Wall -Werror -Wpedantic ${cxx_warn_ignores} -fno-rtti -fno-threadsafe-statics -fno-exceptions  -std=gnu++11 -ffunction-sections -fdata-sections $(DEFINES)
